...
await Bun.write(join(runtime, 'README.md'), '# Browser Agent Runtime\n\nResolve `@kkrausse/browser-agent-runtime/distribution.json`, take its parent directory, and pass that directory to the workspace assets helpers. Serve/copy the validated distribution; do not import workers into the host process. See https://github.com/kkrausse/browser-agent-toolkit/blob/integration/upstream-runtime/docs/RELEASING.md.\n');
